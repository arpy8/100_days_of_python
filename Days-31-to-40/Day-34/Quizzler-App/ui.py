...
class Quiz_App:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label = Label(self.root, text="Score: 0", bg=THEME_COLOR, fg="white", font=("Ariel", 15))
        ...
        self.true_button = Button(self.root, image=true_image, highlightthickness=0, relief=SOLID, border=0.5,
                                  command=self.true_pressed)
        self.true_button.grid(row=2, column=0)

        false_image = PhotoImage(file="images/false.png")
        self.false_button = Button(self.root, image=false_image, highlightthickness=0, relief=SOLID, border=0.5,

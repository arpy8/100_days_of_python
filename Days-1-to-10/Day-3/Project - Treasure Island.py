...
if choice_1 == "left":
    ...
    if choice_2 == "wait":
        choice_3 = input("Your arrive at an island unharmed. There it is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?\n")
        if choice_3 == "blue":
            print("You entered a room full of beasts. Game Over.")
        elif choice_3 == "red":
            print("You were burned by fire. Game Over.")
        elif choice_3 == "yellow":
            print("Congratulations! You entered the room where the treasure was hidden. You Won!")
        else:
